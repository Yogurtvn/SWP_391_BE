...
namespace RepositoryLayer.Migrations
{
    ...
    [Migration("20260502024450_AddPrescriptionCancelledStatus")]
    partial class AddPrescriptionCancelledStatus
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RepositoryLayer.Entities.CartPrescriptionDetail", b =>
                {
                    ...
                    b.ToTable("CartPrescriptionDetails", null, t =>
                        {
                            t.HasCheckConstraint("CK_CartPrescriptionDetails_Axis_Left", "[Axis_Left] BETWEEN 0 AND 180");

                            t.HasCheckConstraint("CK_CartPrescriptionDetails_Axis_Right", "[Axis_Right] BETWEEN 0 AND 180");

                            t.HasCheckConstraint("CK_CartPrescriptionDetails_PD", "[PD] > 0");
                        });
                });
            ...
            modelBuilder.Entity("RepositoryLayer.Entities.PrescriptionSpec", b =>
                {
                    ...
                    b.ToTable("PrescriptionSpecs", null, t =>
                        {
                            t.HasCheckConstraint("CK_PrescriptionSpecs_Axis_Left", "[Axis_Left] BETWEEN 0 AND 180");

                            t.HasCheckConstraint("CK_PrescriptionSpecs_Axis_Right", "[Axis_Right] BETWEEN 0 AND 180");

                            t.HasCheckConstraint("CK_PrescriptionSpecs_PD", "[PD] > 0");

                            t.HasCheckConstraint("CK_PrescriptionSpecs_PrescriptionStatus", "[PrescriptionStatus] IN (1, 2, 3, 4, 5, 6, 7)");
                        });
                });
            ...
            modelBuilder.Entity("RepositoryLayer.Entities.ProductImage", b =>
                {
                    ...
                    b.HasIndex(new[] { "ProductId" }, "IX_ProductImages_ProductId_IsPrimary")
                        .IsUnique()
            ...
            modelBuilder.Entity("RepositoryLayer.Entities.ProductVariant", b =>
                {
                    ...
                    b.Property<int>("PackageHeightCm")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(10);

                    b.Property<int>("PackageLengthCm")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(10);

                    b.Property<int>("PackageWidthCm")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(10);
                    ...
                    b.ToTable("ProductVariants", null, t =>
                        {
                            t.HasCheckConstraint("CK_ProductVariants_PackageHeightCm", "[PackageHeightCm] > 0");

                            t.HasCheckConstraint("CK_ProductVariants_PackageLengthCm", "[PackageLengthCm] > 0");

                            t.HasCheckConstraint("CK_ProductVariants_PackageWidthCm", "[PackageWidthCm] > 0");

                            t.HasCheckConstraint("CK_ProductVariants_WeightGram", "[WeightGram] > 0");
                        });
                });
